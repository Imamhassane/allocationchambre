 ...
 */
final class Version20220325014727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE boursier CHANGE etudiant_id etudiant_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE boursier CHANGE etudiant_id etudiant_id INT NOT NULL');
